package com.go5u.foodflowplatform.foodflowplatform.iam.infrastructure.authorization.sfs.configuration;


import com.go5u.foodflowplatform.foodflowplatform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.go5u.foodflowplatform.foodflowplatform.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.go5u.foodflowplatform.foodflowplatform.iam.infrastructure.tokens.jwt.BearerTokenService;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/api/v1/accounts/*/user-response", // Endpoint para comunicación entre microservicios (sin autenticación)
                                "/v3/api-docs/**",
                                "/swagger-ui.html",
                                "/swagger-ui/**",
                                "/swagger-resources/**",
